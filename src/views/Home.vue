          ...
          <div class="container-sm">
            <div class="hero-inner">
              ...
              <div class="mockup-container">
                ...
                <img
                  class="device-mockup"
                  src="@/assets/images/iphone-hero.png"
                  alt="iPhone Hero"
                />
              </div>
            </div>
              ...
              <div class="container">
                <div class="feature-extended">
                  <div class="feature-extended-image">
                    ...
                    <img
                      class="device-mockup"
                      src="@/assets/images/iphone-feature-01.png"
                  ...
                  <div class="feature-extended-body is-revealing">
                    ...
                    <p class="m-0">
                      Quam quisque id diam vel quam elementum pulvinar. Ut etiam
                      sit amet nisl purus in mollis nunc. Odio morbi quis
                ...
                <div class="feature-extended">
                  <div class="feature-extended-image">
                    ...
                    <img
                      class="device-mockup"
                      src="@/assets/images/iphone-feature-02.png"
                ...
                <div class="feature-extended">
                  <div class="feature-extended-image">
                    <div class="mockup-bg">
                      <img
                        src="@/assets/images/iphone-feature-bg-03.svg"
                        alt="iPhone Feature 03 illustration" data-sr-id="3"
                      />
                    </div>
                    <img
                      class="device-mockup"
                      src="@/assets/images/iphone-feature-03.png"
                      alt="iPhone Feature 03" data-sr-id="3"
                    />
                  </div>
                  <div class="feature-extended-body is-revealing">
                    <h3 class="mt-0 mb-16">Amazing features, coming soon.</h3>
                ...
                <div class="feature-extended">
                  <div class="feature-extended-image">
                    <div class="mockup-bg">
                      <img
                        src="@/assets/images/iphone-feature-bg-04.svg"
                        alt="iPhone Feature 04 illustration"
                      />
                    </div>
                    <img
                      class="device-mockup"
                      src="@/assets/images/iphone-feature-04.png"
          ...
          <div class="container">
            <div class="site-footer-inner">
              ...
              <ul class="footer-links list-reset ">
                ...
                <li>
                  <a href="#" class="white--text">FAQ's</a>
                </li>
                <li>
              ...
              <div class="footer-copyright white--text">
                &copy; 2018 Venus, all rights reserved
              </div>
            </div>
          </div>
        </div>
